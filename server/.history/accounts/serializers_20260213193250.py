...
class AccountDeletionSerializer(serializers.Serializer):
    """Confirm account deletion with OTP and password"""
    ...
    def validate(self, attrs):
        ...
        # Check OTP
        is_valid = verify_otp(user, "ACCOUNT_DELETION", attrs['code'])
...
class DeactivationReasonSerializer(serializers.Serializer):
    """Optional: Collect feedback when user deactivates account"""
