...
from .serializers import DiagnosisSerializer, PrescriptionSerializer
...
class AddPrescriptionView(CreateAPIView):
    queryset = Prescription.object.all()
    serializer_class = PrescriptionSerializer
    permission_classes = [IsAuthenticated, IsDoctor]

    @extend_schema(
        summary="Add Prescription to Diagnosis",
        description="Allows a doctor to attach a medication prescription to an existing diagnosis ID.",
    ...
    @extend_schema(summary="Partially update a prescription", tags=['Consultations'])
    def patch(self, request, *args, **kwargs):
        return super().patch(request, *args, **kwargs)

    @extend_schema(summary="Delete a prescription", tags=['Consultations'])
