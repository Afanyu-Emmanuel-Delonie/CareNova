...
from .serializers import UserRegistrationSerializer, OTPVerificationSerializer, CustomTokenObtainPairSerializer
...
class LoginView(TokenObtainPairView):
    ...
    """
    this section of the application now will cover the user profiles with crude ope
    """
