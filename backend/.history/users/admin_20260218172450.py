...
# 1. This shows Profile details inside the User page
...
class UserAdmin(admin.ModelAdmin):
    # This connects the User to their Profile visually
...
# We unregister the basic Profile registration so it doesn't clutter the sidebar
# since it is now managed inside the UserAdmin inline