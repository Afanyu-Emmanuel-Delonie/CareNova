...
from .serializers import AppointmentSerializer, ReviewSerializer, AvailabilitySlotSerializer, BulkSlotSerializer, DoctorAgendaSerializer, CompleteAppointmentSerializer
...
class PatientHistoryViewSet(viewsets.ReadOnlyModelViewSet):
    serializer_class = PatientHistoryViewSet
