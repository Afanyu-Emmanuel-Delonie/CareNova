...
public class BankAccountTest {
    ...
    // Test Case 7: Test that creating an account with negative balance throws exception
    @Test
    ...
    // Used here to simply display a message (could also be used to clean up resources)
    @AfterEach
